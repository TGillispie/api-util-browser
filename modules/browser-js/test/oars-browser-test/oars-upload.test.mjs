...
describe("oars file upload", () => {
  ...
  const fileSuccessResponse = {
	 ...
	 * 
	 */
	test.skip("upload a .json file", async () => {    
	...
	test.skip("upload a .txt file", async () => {    
  ...
  test.skip("upload a .png file", async () => {    
  ...
  test.skip("upload a .zip file", async () => {
  ...
  test.skip("upload a .gz file", async () => {
